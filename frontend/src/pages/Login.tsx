      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .auth-check-label {
          ...
          font-size: 12px; color: rgba(232,240,255,0.4); cursor: pointer;
        }
        .auth-check-label input { accent-color: #4d8dff; }
        .auth-forgot {
          font-size: 12px; color: #4d8dff; text-decoration: none;
          transition: color 0.2s;
        }
        .auth-forgot:hover { color: #7ab0ff; }
      ...
      <div className="auth-page">
        ...
        <div className="auth-card">
          <div className="auth-header">
            <h2>Welcome back</h2>
            <p>Sign in to your SwiftMall account</p>
          </div>
